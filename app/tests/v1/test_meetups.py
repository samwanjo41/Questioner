...
class MeetupTest(unittest.TestCase):
    ...
    def test_upcoming_meetups(self):
        ...
        get_response = self.client.get('/api/v1/meetups/upcoming', content_type='application/json')
    ...
    def test_specific_meetups(self):
        ...
        self.client.post('/api/v1/meetups/1', data=json.dumps(self.meetup3), content_type='application/json')
        my_response = self.client.get('/api/v1/meetups/1', content_type='application/json')
        result = json.loads(my_response.data.decode())
